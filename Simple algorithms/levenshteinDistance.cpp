...
int main()
{
	...
	int** matrix = new int[length_s1 + 1]; //создадим матрицу размера (длина первого слова +1  х  длина второго слова +2)
	for (int i = 0; i < length_s1 + 1; i++) //s1 - слово, которое буде трасполагаться слева в нашей таблице
	{
